  ...
  return (
    <Box sx={{ paddingInline: '6rem', paddingBlock: '2rem' }}>
      ...
      <List>
        ...
        <ListItem>
        <ListItemText>
          User Content: We collect information that you voluntarily provide when
          using our platform, including item listings, reviews, and messages
          between users.
        </ListItemText>
        </ListItem>
        <ListItem>
        <ListItemText>
          Automated Information: We may collect technical information about your
          device, browsing actions, and usage patterns, such as your IP address,
