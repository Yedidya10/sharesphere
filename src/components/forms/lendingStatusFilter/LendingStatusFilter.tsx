...
export interface ILendingStatusFilter {
  control: any
  filterType: string
  filterName: string
  /**
  ...
  /**
   * How large should the LendingStatusFilter be?
   */
  size?: 'small' | 'medium' | 'large'
  /**
   * LendingStatusFilter contents
   */
  label: string
  /**
...
const LendingStatusFilter: React.FC<ILendingStatusFilter> = ({
  primary = false,
  label,
  control,
  filterType,
